...
from projects.sam3.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames
from projects.sam3.sam.mask_decoder import MaskDecoder, MLP
from projects.sam3.sam.prompt_encoder import PromptEncoder
from projects.sam3.sam.transformer import TwoWayTransformer
from projects.sam3.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from projects.sam3.perflib.compile import compile_wrapper
