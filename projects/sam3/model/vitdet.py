...
from projects.sam3.model.model_misc import AttentionType, LayerScale
from projects.sam3.perflib.fused import addmm_act
from projects.sam3.sam.rope import apply_rotary_enc_real, VisionRotaryEmbeddingVE
...
class Attention(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if self.attn_type == AttentionType.Vanilla:
            if self.use_fa3:
                from projects.sam3.perflib.fa3 import flash_attn_func
