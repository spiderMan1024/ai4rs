...
import torch
from projects.sam3.model.vl_combiner import SAM3VLBackbone

try:
    from projects.sam3.model.vl_combiner import SAM3VLBackboneTri
except ImportError:
    SAM3VLBackboneTri = None
from typing import Dict, List, Optional

import numpy as np
from projects.sam3.model.data_misc import BatchedDatapoint, FindStage
from projects.sam3.model.geometry_encoders import Prompt
from projects.sam3.model.model_misc import SAM3Output
from projects.sam3.model.sam3_image import Sam3Image
from projects.sam3.model.sam3_multiplex_detector_utils import nms_masks
...
class Sam3MultiplexDetector(Sam3MultiplexImageBase):
    ...
    def forward_video_grounding_batched_multigpu(
        ...
        approach from projects.sam3MultiplexImageBase.
