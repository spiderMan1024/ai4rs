...
from projects.sam3.model.sam3_base_predictor import Sam3BasePredictor
...
class Sam3MultiplexVideoPredictor(Sam3BasePredictor):
    ...
    - handle_request / handle_stream_request dispatch API (from projects.sam3BasePredictor)
    """
