...
import numpy as np
import torch
from projects.sam3.model.data_misc import NestedTensor
from projects.sam3.model.io_utils import load_video_frames
from projects.sam3.model.multiplex_utils import MultiplexState
from projects.sam3.model.sam3_tracker_utils import fill_holes_in_mask_scores
from projects.sam3.model.video_tracking_multiplex import (
    concat_points,
    NO_OBJ_SCORE,
...
class VideoTrackingMultiplexDemo(VideoTrackingDynamicMultiplex):
    ...
    def _extract_object_for_interaction(self, inference_state, obj_id, frame_idx):
        ...
        Adapted from projects.sam3_multiplex_tracking._extract_object_to_singleton_state()
