...
import numpy as np
import projects.sam3.model.sam3_multiplex_base
import projects.sam3.model.sam3_video_base
import torch
import torch.distributed as dist
import torch.nn.functional as F
from projects.sam3 import perflib
from projects.sam3.logger import get_logger
from projects.sam3.model.box_ops import box_xywh_to_cxcywh, box_xyxy_to_xywh
from projects.sam3.model.data_misc import BatchedDatapoint
from projects.sam3.model.sam3_multiplex_base import MaskletConfirmationStatus, Sam3MultiplexBase
from projects.sam3.model.sam3_tracker_utils import fill_holes_in_mask_scores
from projects.sam3.model.sam3_video_inference import is_image_type
from projects.sam3.perflib.compile import (
    clone_output_wrapper,
    compile_wrapper,
    shape_logging_wrapper,
)
from projects.sam3.perflib.masks_ops import mask_iou, masks_to_boxes as perf_masks_to_boxes
...
from projects.sam3.model.data_misc import (
    BatchedPointer,
    convert_my_tensors,
    FindStage,
    NestedTensor,
)
from projects.sam3.model.geometry_encoders import Prompt
from projects.sam3.model.io_utils import load_resource_as_video_frames
...
class Sam3MultiplexTracking(Sam3MultiplexBase):
    ...
    def init_state(
        ...
        # Initialize inference state (inlined from projects.sam3DemoMixin.init_state)
        if use_torchcodec:
    ...
    def reset_state(self, inference_state):
        # Inlined from projects.sam3DemoMixin.reset_state
    ...
    def add_prompt(
        ...
        Copied from projects.sam3_demo.Sam3DemoMixin.add_prompt, simplified to support only text prompts.
        """
