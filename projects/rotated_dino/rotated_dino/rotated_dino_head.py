...
from projects.rotated_deformable_detr.rotated_deformable_detr import RotatedDeformableDETRHead


class RotatedDINOHead(DINOHead, RotatedDeformableDETRHead):
